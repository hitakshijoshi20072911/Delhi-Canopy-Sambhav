  ...
  public: {
    Tables: {
      ...
      climate_data: {
        ...
        Relationships: [
          {
            foreignKeyName: "climate_data_ward_id_fkey"
            columns: ["ward_id"]
            isOneToOne: false
            referencedRelation: "wards"
            referencedColumns: ["id"]
      ...
      co2_absorption: {
        ...
        Relationships: [
          {
            foreignKeyName: "co2_absorption_ward_id_fkey"
            columns: ["ward_id"]
            isOneToOne: false
            referencedRelation: "wards"
            referencedColumns: ["id"]
      ...
      heat_indices: {
        ...
        Relationships: [
          {
            foreignKeyName: "heat_indices_ward_id_fkey"
            columns: ["ward_id"]
            isOneToOne: false
            referencedRelation: "wards"
            referencedColumns: ["id"]
      ...
      ndvi_scores: {
        ...
        Relationships: [
          {
            foreignKeyName: "ndvi_scores_ward_id_fkey"
            columns: ["ward_id"]
            isOneToOne: false
            referencedRelation: "wards"
            referencedColumns: ["id"]
      ...
      plantation_plans: {
        Row: {
          ...
          created_at: string | null
          estimated_co2_offset: number | null
          estimated_cost_inr: number | null
          estimated_heat_reduction: number | null
          id: string
          implementation_timeline: string | null
          land_type: Database["public"]["Enums"]["land_type"]
          plan_date: string
          priority_score: number
          recommended_species: Json | null
        ...
        Relationships: [
          {
            foreignKeyName: "plantation_plans_ward_id_fkey"
            columns: ["ward_id"]
            isOneToOne: false
            referencedRelation: "wards"
            referencedColumns: ["id"]
      ...
      risk_assessments: {
        ...
        Relationships: [
          {
            foreignKeyName: "risk_assessments_ward_id_fkey"
            columns: ["ward_id"]
            isOneToOne: false
            referencedRelation: "wards"
            referencedColumns: ["id"]
